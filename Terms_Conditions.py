...
class TermsConditions(ctk.CTkFrame):
	...
	def introduction(self):
		...
		term1_label = ctk.CTkLabel(self, text = "Consent for Data Collection: You consent to the collection and processing of your personal data for the purposes of COVID-19 contact tracing. This may include collecting information such as your name, contact number, address.", font=("Helvetica", 10), wraplength=500)
		...
		term3_label = ctk.CTkLabel(self, text = "User Responsibilities: You agree to provide accurate information during registration. You are responsible for keeping your reference number secure and for any activities conducted using your reference number.", font=("Helvetica", 10), wraplength=500)        
